...
public record Post(URI uri, String authorDid, String text, Instant createdAt, Optional<String> reason, boolean hasEmbeds, boolean hasVideos, Set<String> labels, JsonObject json) {
    @Override
